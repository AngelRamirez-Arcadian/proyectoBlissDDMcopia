    ...
    return ( 
        ...
        <div className="sm:grid sm:grid-cols-1 sm:justify-items-center sm:text-3x1 sm:place-content-center md:grid md:grid-cols-1 md:justify-items-center md:text-3x1 md:place-content-center">
                ...
                <div className="sm:space-x-4 sm:flex sm:justify-center md:space-x-4 md:flex md:justify-center">
                    <h1 className="fecha-2 sm:text-xs md:text-xs sm:text-center md:text-center">MARZO - SEPTIEMBRE 2011</h1>
                </div>
                ...
                <div>
                    <h1 className="subtitulo-3 sm:text-xs md:text-base sm:text-center md:text-center">&#60;Desarrollador Java web/&#62;</h1>
                </div>
                ...
                <div className="textos-3 sm:mt-2 sm:container md:mt-6 md:container md:mx-auto">
                    ...
                    <p>Contribución al desarrollo de una red social con enfoque educativo.</p>
                    <p>Implementación de características en el servidor usando Hibernate y Struts</p>
                    </h1>
                </div>
...
export default InfocurriculumP8;