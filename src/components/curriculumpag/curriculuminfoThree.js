    ...
    return ( 
        ...
        <div className="sm:grid sm:grid-cols-1 sm:justify-items-center sm:text-3x1 sm:place-content-center md:grid md:grid-cols-1 md:justify-items-center md:text-3x1 md:place-content-center">
                ...
                <div className="textos-3 sm:mt-2 sm:container md:mt-6 md:container md:mx-auto">
                    ...
                    <p className="sm:font-bold md:font-bold md:pb-2">American Express</p>
                    <p>Desarrollo en diversas partes de la aplicación de reservaciones, creando módulos y/o componentes Angular/React.</p>
                    <p>Mejora de código legacy en jQuery para poder trabajar junto con directivas y aplicaciones de Angular.</p>
                    <p>Desarrollo de características nuevas en Ruby on Rails para colaborar con las tareas necesarias del front end.</p>
                    <p>Dirección equipos de front end.</p></h1>
                </div>

                <div className="md:mt-28 sm:mt-28">
...
export default InfocurriculumP3;